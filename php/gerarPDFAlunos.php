...
while($row = $query->fetch_assoc()){
    ...
    $mpdf->WriteHTML('<tr>');
        ...
        $mpdf->WriteHTML("<td>".strtoupper($row["cep"])."</td>");

        $mpdf->WriteHTML("<td>".strtoupper($row["cidade"])."</td>");

        $mpdf->WriteHTML("<td>".strtoupper($row["bairro"])."</td>");

        $mpdf->WriteHTML("<td>".strtoupper($row["rua"])."</td>");
